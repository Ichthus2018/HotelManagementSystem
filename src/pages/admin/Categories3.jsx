...
// Modals
import AddCategory3Modal from "../../components/Admin/Modals/Category3/AddCategory3Modal";
import DeleteConfirmationModal from "../../components/ui/common/DeleteConfirmationModal";
import EditCategory3Modal from "../../components/Admin/Modals/Category3/EditCategory3Modal";

// Lazy-loaded View Component
const Category3List = lazy(() =>
  import("../../components/Admin/Modals/Category3/Pages/Category3List")
);
  ...
  return (
    <>
      <div className="space-y-6 w-full mx-auto p-2 pt-10 md:p-6 max-w-[95rem] xl:px-12 min-h-screen">
        <PageHeader
          title="Manage Categories 3"
          description="Add or remove tertiary categories for your system."
      ...
      {selectedCategory && (
        <>
          ...
          <DeleteConfirmationModal
            ...
            itemName={selectedCategory.category_3_name}
          />
        </>
      )}
    </>
