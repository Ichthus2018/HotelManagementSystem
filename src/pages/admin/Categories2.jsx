...
import EditCategory2Modal from "../../components/Admin/Modals/Category2/EditCategory2Modal";

// Lazy-loaded View Component
const Category2List = lazy(() =>
  import("../../components/Admin/Modals/Category2/Pages/Category2List")
);
  ...
  return (
    <>
      <div className="space-y-6 w-full mx-auto p-2 pt-10 md:p-6 max-w-[95rem] xl:px-12 min-h-screen">
        <PageHeader
          title="Manage Categories 2"
          description="Add or remove secondary categories for your system."
      ...
      {selectedCategory && (
        <>
          ...
          <DeleteConfirmationModal
            ...
            itemName={selectedCategory.category_2_name}
          />
        </>
      )}
    </>
