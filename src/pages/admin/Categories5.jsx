...
// Modals
import AddCategory5Modal from "../../components/Admin/Modals/Category5/AddCategory5Modal";
import DeleteConfirmationModal from "../../components/ui/common/DeleteConfirmationModal";
import EditCategory5Modal from "../../components/Admin/Modals/Category5/EditCategory5Modal";

// Lazy-loaded View Component
const Category5List = lazy(() =>
  import("../../components/Admin/Modals/Category5/Pages/Category5List")
);
...
const Categories5 = () => {
  ...
  const {
    ...
    tableName: "categories_5",
    selectQuery: "*",
    searchColumn: "category_5_name",
    initialPageSize: 5,
  });
  ...
  return (
    <>
      <div className="space-y-6 w-full mx-auto p-2 pt-10 md:p-6 max-w-[95rem] xl:px-12 min-h-screen">
        <PageHeader
          title="Manage Categories 5"
          description="Add or remove quinary categories for your system."
      ...
      {selectedCategory && (
        <>
          ...
          <DeleteConfirmationModal
            ...
            itemName={selectedCategory.category_5_name}
          />
        </>
      )}
    </>
