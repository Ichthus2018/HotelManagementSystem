// src/components/Admin/Modals/Amenities/AddAmenityModal.jsx
...
const AddAmenityModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { error: insertError } = await supabase
        ...
        .insert([{ item_code: itemCode, item_name: itemName, status }]);
