// File: src/components/Admin/Modals/RoomAssignments/Pages/RoomAssignmentsList.jsx
...
const RoomAssignmentsList = ({ rooms, onEdit, onDelete, onTagUsers }) => {
  return (
        ...
        >
          ...
          <div className="mt-auto p-5 pt-4 border-t border-gray-100 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => onTagUsers(room)}
                className="p-2 text-gray-500 rounded-full hover:bg-green-100 hover:text-green-600 transition-colors"
                title={`Assign roles for Room ${room.room_number}`}
              >
...
export default RoomAssignmentsList;
