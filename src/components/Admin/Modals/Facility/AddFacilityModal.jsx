// src/components/Admin/Modals/Facility/AddFacilityModal.jsx
...
const AddFacilityModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const [check_in, setCheckIn] = useState("14:00"); // Replaced availability
  const [check_out, setCheckOut] = useState("11:00"); // Added check-out
