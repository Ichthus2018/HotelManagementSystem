...
const EditCategory1Modal = ({ isOpen, onClose, onSuccess, category }) => {
  ...
  useEffect(() => {
    if (category) {
      setCategory1Code(category.category_1_code || "");
      setCategory1Name(category.category_1_name || "");
...
export default EditCategory1Modal;
