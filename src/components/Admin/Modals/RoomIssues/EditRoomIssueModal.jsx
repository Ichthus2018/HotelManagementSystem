...
const EditRoomIssueModal = ({ isOpen, onClose, onSuccess, issue }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      const fetchRooms = async () => {
        ...
        if (error) setError("Failed to fetch rooms.");
        else setRooms(data);
  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={handleClose}>
        {/* ... (The Transition and Dialog structure is identical to the Add Modal) ... */}
        <TransitionChild
          as={Fragment}
...
export default EditRoomIssueModal;
