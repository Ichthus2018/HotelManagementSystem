// src/components/Modals/AddRoomAreaModal.js
...
const AddRoomAreaModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error adding room area:", err);
      setError(err.message || "Failed to add room area.");
    } finally {
