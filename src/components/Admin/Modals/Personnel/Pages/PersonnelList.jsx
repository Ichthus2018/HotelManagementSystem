...
const PersonnelList = ({ personnel, onEdit, onDelete, onChangePassword }) => {
  ...
  const getRoleBadge = (person) => {
    // Read the role name from the nested sidebar_permissions object
    const roleName = person.sidebar_permissions?.role_name || "No Role";
          ...
          <div className="flex items-start gap-4 sm:gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-600">
                Member since: {new Date(person.created_at).toLocaleDateString()}
              </p>
            </div>
