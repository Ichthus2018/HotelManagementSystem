  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/backendLock/locks/${lockId}/cards`,
        payload
      );
      ...
      // The API response from the function (forwarded from TTLock) includes the final data
      const newCardData = {
        cardId: response.data.cardId,
        cardNumber: response.data.cardNumber, // The CORRECT, converted number from TTLock
        cardName,
        startDate: startTimestamp,
        endDate: endTimestamp,
        lockId,
